...
int main (void){
    ...
    // // 서식지정자, #붙이면 진법표시해줌
    // h, , l, ll 순으로 short,그냥,long, longlong
    // %d %i = 10진수 int
    // %#o %u %#x(X) = 8진,10진,16진 unsigned int
    // %#f %#e(E)%g(G) = 소수점-지수 표현

    // // 필드 너비와 줄맞춤 --> 출력너비, 정밀도 순으로 (%10.12f면 10칸따고 12칸 정밀도)
    // printf("%5d",123); // <><>123
    // printf("%10f",2.172717); // <><>2.172717
    // printf("%010.12f",12341.2343); // 빈칸 0으로 채움

    // // 부동소수점수 정밀도
    // printf("%.2f");
    // printf("%5.4f",3.14159);  // 3.1416
